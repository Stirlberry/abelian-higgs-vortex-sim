#!/usr/bin/env python3
"""
Abelian-Higgs Vortex Simulation  —  Claude Code edition  v4.17
===============================================================
Changes vs v4.16:
...
def to_rgb():
    ...
    global _s_amp, _s_ph, _s_tmp, _s_r, _s_g, _s_b, _s_rgb, _s_u8
    mode = S['mode']
    ...
    if mode == 'phase':
        ...
        e_max = float(_s_amp[in_circle].max()) or 1.0
        _s_amp /= e_max
...
try:
    fig.canvas.manager.set_window_title('Abelian-Higgs Vortex Simulation  v4.17')
except Exception:
    pass
...
print("Abelian-Higgs Vortex Simulation v4.17 (PDG 2025 constants)")
