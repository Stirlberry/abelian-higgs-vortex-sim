#!/usr/bin/env python3
"""
Abelian-Higgs Vortex Simulation  —  Claude Code edition  v4.2
==============================================================
Changes vs v4.1:
  - Damping slider (range 0.990 – 1.000, step 0.001, default 0.999).
    DAMP is no longer a compile-time constant; it is read from S['damp']
    every step, so the slider takes effect immediately.

    1.000  →  pure Hamiltonian: vortices orbit forever, waves never die
    0.999  →  light dissipation (≈ v4 default)
    0.990  →  heavy damping: vortices freeze, waves absorbed quickly
...
try:
    fig.canvas.manager.set_window_title('Abelian-Higgs Vortex Simulation  v4.2')
except Exception:
    pass
...
print("Abelian-Higgs Vortex Simulation v4.2 (damping slider)")
